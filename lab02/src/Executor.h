...
public:
    ...
    Executor()
    {
        ...
        _alu_funcs[AluFunc::Slt] = [this](Word op1, Word op2) { return ((int16_t)op1 < (int16_t)op2); };
        _alu_funcs[AluFunc::Sltu] = [this](Word op1, Word op2) { return (op1 < op2); };
        ...
        _alu_funcs[AluFunc::Sra] = [this](Word op1, Word op2) { return ((int16_t)op1 >> (op2 % 32)); };
        _alu_funcs[AluFunc::Srl] = [this](Word op1, Word op2) { return op1 >> (op2 % 32); };
        _br_funcs[BrFunc::Eq] = [this](Word op1, Word op2) { return (op1 == op2); };
        _br_funcs[BrFunc::Neq] = [this](Word op1, Word op2) { return (op1 != op2); };
        _br_funcs[BrFunc::Lt] = [this](Word op1, Word op2) { return ((int16_t)op1 < (int16_t)op2); };
        _br_funcs[BrFunc::Ltu] = [this](Word op1, Word op2) { return (op1 < op2); };
        _br_funcs[BrFunc::Ge] = [this](Word op1, Word op2) { return ((int16_t)op1 >= (int16_t)op2); };
        _br_funcs[BrFunc::Geu] = [this](Word op1, Word op2) { return (op1 >= op2); };
